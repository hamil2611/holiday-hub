    ...
    <div class="envlope-wrapper">
      <div id="envelope" class="close" >
        ...
        <div ref="letterRef" :class="{'letter': true, 'letter-detail': isDetail}">
          <span v-if="!isDetail" style="font-size: 20px; color: #8B3A3A;">
            Gửi bạn Khánh Linh !!!
            <br/>
          ...
          <el-scrollbar v-else max-height="250px" style="width: 100%;">
            <div  style="font-size: 13px; text-align: left; display: flex; align-items: flex-start; justify-content: flex-start; flex-direction: column; width: 100%">
              <span>20-10 vui vẻ nhé Khánh Linh 🌹!!</span>
              <span>Mong bạn luôn hạnh phúc, yêu đời, và giữ mãi nụ cười đáng yêu ấy mỗi ngày !!!</span>
            </div>
          </el-scrollbar>
...
import khanhLinh from "@/assets/images/khanh-linh.jpeg"
